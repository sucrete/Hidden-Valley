...
const WeatherModule = async () => {
  ...
  return (
    <div className="weather-container flex flex-row items-center pr-6 bg-[#001e18] p-2 ml-auto justify-between rounded-2xl">
      <div className="today-weather-container basis-[35%] bg-[#01251e] text-accent flex flex-col px-6 py-4 rounded-[12px] items-center justify-between space-y-3 realistic-shadow-md border-1 border-[#66727012]">
      ...
      <div className="flex flex-row justify-between w-[60%]">
        {forecast.map(({ day, hi, lo, Icon }: ForecastDay) => (
          <div key={day} className="tomorrow-weather-container flex flex-col items-center text-accent/60 gap-4 w-full monospaced">
