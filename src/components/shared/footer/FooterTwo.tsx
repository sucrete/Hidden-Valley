  ...
  return (
    <footer className="bg-secondary dark:bg-background-8 relative overflow-hidden">
      ...
      <CTAV1
        ...
        inputFieldClass="shadow-1 placeholder:text-accent/60 border-stroke-7 dark:border-stroke-7 dark:placeholder:text-accent/60 focus:border-accent/60 bg-accent/10 text-accent h-12 w-[85%] rounded-full border px-[18px] py-3   placeholder:  focus:outline-none md:w-[71%] lg:max-w-[340px] dark:bg-transparent"
      />
      ...
      <div className="main-container border-t-stroke-6 dark:border-t-accent/10 relative z-10 border-t px-5">
          ...
          <div className="col-span-12 xl:col-span-4">
            <RevealAnimation delay={0.3}>
              <div className="xl:max-w-[306px]">
                ...
                <p className="text-accent/60 text-tagline-1 mt-4 mb-7  ">
          ...
          <div className="col-span-12 grid grid-cols-12 xl:col-span-8">
            <div className="col-span-12 md:col-span-4">
              <RevealAnimation delay={0.4}>
                <div className="space-y-8">
                  <p className="sm:text-heading-6 text-tagline-1 text-primary-50  ">Company</p>
            ...
            <div className="col-span-12 md:col-span-4">
              <RevealAnimation delay={0.5}>
                <div className="space-y-8">
                  <p className="sm:text-heading-6 text-tagline-1 text-primary-50  ">Support</p>
            ...
            <div className="col-span-12 md:col-span-4">
              <RevealAnimation delay={0.6}>
                <div className="space-y-8">
                  <p className="sm:text-heading-6 text-tagline-1 text-primary-50  ">Legal Policies</p>
                  <ul className="space-y-5">
                    <li>
        ...
        <div className="relative pt-6 pb-10 text-center">
          ...
          <RevealAnimation delay={0.7} offset={10} start="top 105%">
            <p className="text-tagline-1 max-sm:text-tagline-2 text-primary-50  ">
