...
const MegaMenuItem = ({ item }: MegaMenuItemProps) => {
  return (
    <li>
      <Link
        href={item.href}
        className="text-secondary/80 dark:text-accent/80 dark:hover:text-accent group/item text-tagline-1 hover:text-secondary flex items-center gap-1 transition-all duration-200">
