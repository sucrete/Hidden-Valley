  ...
  return (
    <li className="relative space-y-0">
      <button
        ...
        className={cn(
          'sub-menu text-tagline-1 border-stroke-4 dark:border-stroke-6 flex w-full cursor-pointer items-center justify-between border-b py-3 text-left   transition-all duration-200',
