...
import { LongArrow } from '@/components/ui/Icons';
            ...
            <div>
              <div className="absolute bottom-4 left-4 right-4 md:right-auto md:w-[300px] z-10">
                ...
                <div className="brow w-full flex flex-row align-middle justify-between items-center pb-2 border-b border-accent/20">
                  <div className="hole-number font-serif text-white text-xl md:text-3xl leading-[-1px]"> Hole {activeIndex + 1}</div>
                </div>
                ...
                <div className="descripsh text-white text-[13px] py-2 border-b border-solid border-accent/20">
                  {courseHoles[activeIndex].holeDescription}
                </div>
                <div className="tee-boxes space-x-2 text-white text-[13px] py-2">
                ...
                <div className="navigation flex flex-row justify-between items-center pt-4 pb-2 border-t border-accent/20">
                  <button className="custom-prev transition-opacity disabled:opacity-30 hover:cursor-pointer opacity-60 hover:opacity-100">
                    <LongArrow className="fill-white rotate-180 w-[22px] h-[22px]" />
                  </button>
                  <button className="custom-next transition-opacity disabled:opacity-30 hover:cursor-pointer opacity-60 hover:opacity-100">
                    <LongArrow className="fill-white w-[22px] h-[22px]" />
                  </button>
                </div>
              </div>
