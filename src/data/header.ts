...
export const navigationItems: NavigationItem[] = [
  //~ --- example of a dropdown menu item ↓↓↓
  // {
  //   id: 'home',
  //   label: 'Home',
  //   href: '#',
  ...
  //* --- example of a header link item (no dropdown) ↓↓↓
  // {
  //   id: 'contact',
  //   label: 'Contact Us',
  //   href: '/contact-us',
...
export const ratesMenuItems: MegaMenuItem[] = [
  { id: 'greens-fees', label: 'Greens Fees', href: '/greens-fees' },
  { id: 'membership', label: 'Membership Fees', href: '/membership' },
];
...
//* Homes Mega Menu Items *edited down to just the ones I need
export const homeMegaMenuItems: MegaMenuItem[] = [
  { id: 'home-1', label: 'Homepage 1', href: '/homepage-04' },
  { id: 'home-2', label: 'Homepage 2', href: '/homepage-25' },
  { id: 'home-3', label: 'Homepage 3', href: '/homepage-34' },
  { id: 'home-4', label: 'Homepage 4', href: '/homepage-36' },
];
//* Pages Mega Menu Items *edited down to just the ones I need
export const pageMegaMenuItems: MegaMenuItem[] = [
  { id: 'home-1', label: 'Homepage 1', href: '/homepage-04' },
  { id: 'home-2', label: 'Homepage 2', href: '/homepage-25' },
  { id: 'home-3', label: 'Homepage 3', href: '/homepage-34' },
  { id: 'home-4', label: 'Homepage 4', href: '/homepage-36' },
...
//* A list of pages I want on deck
export const pagesMegaMenuColumns: MegaMenuColumn[] = [
  {
    id: 'column-1',
    items: [
      { id: 'home-1', label: 'Homepage 1', href: '/' },
      { id: 'home-2', label: 'Homepage 4', href: '/homepage-04' },
      { id: 'home-3', label: 'Homepage 25', href: '/homepage-25' },
      { id: 'home-4', label: 'Homepage 34', href: '/homepage-34' },
      { id: 'home-5', label: 'Homepage 36', href: '/homepage-36' },
      { id: 'home-6', label: 'Tutorial', href: '/tutorial' },
      { id: 'home-7', label: 'Pricing 3', href: '/pricing-03' },
      { id: 'home-8', label: 'Features 1', href: '/features-01' },
      { id: 'home-9', label: 'Case Study', href: '/case-study' },
      { id: 'home-10', label: 'Affiliates', href: './affiliates' },
    ],
  },
  {
    id: 'column-2',
    items: [
      { id: 'home-14', label: 'FAQ', href: '/faq' },
      { id: 'home-15', label: 'Login 4', href: '/login-04' },
      { id: 'home-16', label: 'Our Services', href: '/our-services' },
      { id: 'home-17', label: 'Our Services 2', href: '/our-services-02' },
      { id: 'home-18', label: 'Privacy', href: '/privacy' },
      { id: 'home-19', label: 'Testimonial 1', href: '/testimonial-01' },
      { id: 'home-20', label: 'Blog 1', href: '/blog-01' },
      { id: 'home-21', label: 'About 1', href: '/about-01' },
    ],
  },
];
...
export const splitMenuRight: NavigationItem[] = [
  {
    id: 'contact',
    label: 'Contact',
    href: '/contact',
